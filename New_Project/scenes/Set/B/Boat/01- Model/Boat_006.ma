...
//Name: Boat_006.ma
//Last modified: Mon, Sep 11, 2017 10:50:00 AM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.5065462639469347 13.599909028234157 -3.5800656286988866 ;
	setAttr ".r" -type "double3" -71.738352729731105 399.39999999975504 0 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 0.022989873960118815;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.8020487589358607 0.48798811435699463 7.1275628082566627 ;
	setAttr ".hc" -type "string" "viewSet -p %camera";
createNode transform -s -n "top";
	rename -uid "CC60EE71-7848-782E-3F75-FDAE7201F3AC";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.8641434828234515 1000.1299374653116 5.5485889056478239 ;
...
createNode transform -s -n "front";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.4737197963811681 0.47267971652212315 1000.1034781290288 ;
createNode camera -s -n "frontShape" -p "front";
	rename -uid "D72FADFE-634F-5810-FE71-B2B8A4A25642";
	setAttr -k off ".v";
	setAttr ".rnd" no;
	setAttr ".coi" 982.07194517565063;
	setAttr ".ow" 3.2981630527507346;
...
createNode transform -s -n "side";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1000.1457802189684 0.030956908539818362 -4.5470037120885287 ;
...
createNode mesh -n "pCubeShape2" -p "pCube2";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 63 ".pt";
	setAttr ".pt[0]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[3]" -type "float3" 0 -3.7252903e-09 1.8626451e-08 ;
	setAttr ".pt[6]" -type "float3" -0.21835943 -0.042553332 -0.0041493671 ;
	setAttr ".pt[7]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[10]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[11]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[14]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[15]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[19]" -type "float3" -0.22871397 0.010049837 -0.0048073647 ;
	setAttr ".pt[21]" -type "float3" 0 0 -0.017768132 ;
	setAttr ".pt[26]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[27]" -type "float3" 8.3446503e-07 0 0 ;
	setAttr ".pt[36]" -type "float3" 8.3446503e-07 0 0 ;
	...
	setAttr ".pt[286]" -type "float3" 8.3446503e-07 0 0 ;
	...
	setAttr ".pt[360]" -type "float3" 0.083034664 0 0 ;
	setAttr ".pt[361]" -type "float3" 0.16615951 0 0 ;
	...
	setAttr ".pt[387]" -type "float3" 8.3446503e-07 0 0 ;
...
createNode mesh -n "pCubeShape9" -p "pCube9";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.37782074511051178 0.5 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
